      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-36'>
        <div className='flex flex-col lg:flex-row items-center justify-between gap-12'>
          <div className='flex-1 text-center lg:text-left'>
            <h1 className="text-3xl sm:text-4xl 2xl:text-7xl font-bold text-gray-900 leading-tight mb-6 lg:mb-12">
              태양광 설비 전문가와 함께
              <span className="block text-blue-600 mt-2 lg:mt-6">Add commentMore actions
                미래를 만들어갑니다.
              </span>
            </h1>
        ...
        <div className='flex-1 w-full max-w-2xl lg:max-w-none'>
          <div className='realtive'>
            <img src={HeroImage}
              className='relative roun shadow-2xl w-full object-cover transform hover:scale-[1.02] transition-transform duration-300' 
            />
