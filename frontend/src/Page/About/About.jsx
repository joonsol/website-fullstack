...
const About = () => {
  return (
    <div className='container mx-auto px-4 py-32 max-w-7xl'>
      ...
      >
        <img src={companyImage} alt="img" className='w-full h-full object-cover' />
        <div
          className='absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-slate-900'
        ></div>
        <div
          className='
          absolute bottom-8 left-8 md:bottom-12 md:left-12 text-white
        '>
      ...
      <div className='grid grid-cols md:grid-cols-3 gap-10 mb-24'>
        {[
          ...
          <div
            className='bg-white p-10 rounded-lg text-center hover:shadow-2xl transition-all duration-300 border border-gray-100'
            key={index}>
      ...
      <div className='mb-24 max-w-4xl mx-auto text-center'>
        <h2 className='text-4xl font-bold mb-8 text-slate-800'>회사비전</h2>
        <p className='text-2xl leading-relaxed text-gray-600 font-light'> "2030년까지 글로벌 시장을 선도하는 기술 혁신 기업으로 도약하여,Add commentMore actions
          <br />더 나은 세상을 만드는데 기여하겠습니다."</p>
      </div>

      <div className='mb-24'>
        <h2 className='text-4xl font-bold mb-8 text-slate-800 text-center'>회사연혁</h2>
